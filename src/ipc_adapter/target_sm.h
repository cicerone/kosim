...
public:
    ...
    boost::interprocess::interprocess_condition  cond_irq_sync;  // condition to sync between processes
    ...
    boost::interprocess::interprocess_condition  cond_buff_rd_sync;  //Condition to sync between processes
    ...
    boost::interprocess::interprocess_condition  cond_buff_wr_sync;  //Condition to sync between processes
